...
// Generated at 2026-05-02T14:50:44.877Z
...
MERGE (n:APIEndpoints {id: 'api-product-operations-duplicate'})
SET n.method = 'POST',
    n.uri = '/api/products/{id}/duplicate',
    n.handler = 'ProductOperationsController.duplicate';
MERGE (n:APIEndpoints {id: 'api-product-operations-importproducts'})
SET n.method = 'POST',
    n.uri = '/api/products/import',
    n.handler = 'ProductOperationsController.importProducts';
...
SET n.name = 'ProductService.delete',
    n.kind = 'command';
MERGE (n:Action {id: 'action-product-duplicate'})
SET n.name = 'ProductService.duplicate',
    n.kind = 'command';
...
SET n.name = 'ProductService.findById',
    n.kind = 'query';
MERGE (n:Action {id: 'action-product-importproducts'})
SET n.name = 'ProductService.importProducts',
    n.kind = 'command';
...
MATCH (s:Module {id:'mod-product'}), (t:Action {id:'action-product-duplicate'}) MERGE (s)-[:CONTAINS]->(t);
...
MATCH (s:Module {id:'mod-product'}), (t:Action {id:'action-product-importproducts'}) MERGE (s)-[:CONTAINS]->(t);
...
MATCH (s:Module {id:'mod-product'}), (t:APIEndpoints {id:'api-product-operations-duplicate'}) MERGE (s)-[:CONTAINS]->(t);
MATCH (s:Module {id:'mod-product'}), (t:APIEndpoints {id:'api-product-operations-importproducts'}) MERGE (s)-[:CONTAINS]->(t);
...
MATCH (s:Action {id:'action-product-duplicate'}), (t:Entity {id:'entity-product'}) MERGE (s)-[:OPERATES_ON]->(t);
...
MATCH (s:Action {id:'action-product-importproducts'}), (t:Entity {id:'entity-product'}) MERGE (s)-[:OPERATES_ON]->(t);
